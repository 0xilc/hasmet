...
class ThinLensCamera : public Camera {
 public:
  ThinLensCamera(const Vec3& position, const Vec3& look_at, const Vec3& up,
                 float vertical_fov_degrees = 90.f, int film_width = 100,
                 int film_height = 100,
                 std::string image_name = "thinlens_output",
                 const glm::mat4& transform = glm::mat4(1.0f),
                 int num_samples = 1, float aperture_size = 0,
